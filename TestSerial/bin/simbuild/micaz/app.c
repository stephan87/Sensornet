...
typedef TMilli TestSerialC$Timer0$precision_tag;
...
static void TestSerialC$Timer0$fired(void );
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void TestSerialC$AMControl$startDone(error_t error);
#line 117
static void TestSerialC$AMControl$stopDone(error_t error);
...
uint8_t arg_0x40ad03a8);
# 71 "/opt/tinyos-2.1.1/tos/lib/timer/Counter.nc"
static void /*HilTimerMilliC.CounterToLocalTimeC*/CounterToLocalTimeC$0$Counter$overflow(void );
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t TestSerialC$AMControl$start(void );
...
bool TestSerialC$busy[1000];
message_t TestSerialC$pkt[1000];
...
static inline void TestSerialC$AMControl$startDone(error_t err);
#line 49
static inline void TestSerialC$AMControl$stopDone(error_t err);
static inline void TestSerialC$Timer0$fired(void );
#line 71
static inline void TestSerialC$AMSend$sendDone(message_t *msg, error_t error);
#line 85
static inline message_t *TestSerialC$Receive$receive(message_t *msg, void *payload, uint8_t len);
# 32 "/opt/tinyos-2.1.1/tos/interfaces/GeneralIO.nc"
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408f4cc0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408f4cc0, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408f4628, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408f4628, msg, payload, len);
#line 67
...
#line 124
{
  ...
  sim_log_debug(125U, "Serial", "Sending serial message (%p) of type %hhu and length %hhu @ %s.\n", msg, SerialActiveMessageC$AMPacket$type(msg), len, sim_time_string());
...
#line 69
  __nesc_result = SerialActiveMessageC$AMSend$send(AM_TESTSERIALMSG, addr, msg, len);
#line 69
...
#line 69
# 217 "/opt/tinyos-2.1.1/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline void *SerialActiveMessageC$Packet$getPayload(message_t *msg, uint8_t len)
#line 217
{
  if (len <= 28) {
...
{
  LedsP$Led2$set();
  sim_log_debug(59U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 100
  ;
}
...
{
  LedsP$Led2$clr();
  sim_log_debug(58U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 95
  ;
}
...
{
  LedsP$Led1$set();
  sim_log_debug(56U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 85
  ;
}
...
{
  LedsP$Led1$clr();
  sim_log_debug(55U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 80
  ;
}
...
{
  LedsP$Led0$set();
  sim_log_debug(53U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 70
  ;
}
...
{
  LedsP$Led0$clr();
  sim_log_debug(52U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 65
  ;
}
...
static inline message_t *TestSerialC$Receive$receive(message_t *msg, void *payload, uint8_t len)
{
  if (len == sizeof(TestSerialMsg )) 
    {
      TestSerialMsg *msgReceived = (TestSerialMsg *)payload;
...
#line 99
            if (!TestSerialC$busy[sim_node()]) 
              {
                TestSerialMsg *msgToSend = (TestSerialMsg *)TestSerialC$Packet$getPayload(&TestSerialC$pkt[sim_node()], sizeof(TestSerialMsg ));
...
#line 102
                ...
                if (TestSerialC$AMSend$send(AM_BROADCAST_ADDR, &TestSerialC$pkt[sim_node()], sizeof(TestSerialMsg )) == SUCCESS) 
                  {
                    sim_log_debug(49U, "TestSerialC", "Node %d: message forwarded\n", __nesc_ntoh_uint16(msgToSend->sender.nxdata));
                    TestSerialC$busy[sim_node()] = TRUE;
                  }
              }
            }
        }
      else {
          sim_log_debug(50U, "TestSerialC", "Node %d Received duplicate Message from %d with seqNum: %d ledNum: %d\n", TOS_NODE_ID, __nesc_ntoh_uint16(msgReceived->sender.nxdata), __nesc_ntoh_uint16(msgReceived->seqNum.nxdata), __nesc_ntoh_uint16(msgReceived->ledNum.nxdata));
        }
    }
  return msg;
}

# 248 "/opt/tinyos-2.1.1/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline message_t *SerialActiveMessageC$Receive$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len)
#line 248
{
  return msg;
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * SerialActiveMessageC$Receive$receive(am_id_t arg_0x40935108, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40935108) {
#line 67
    case AM_TESTSERIALMSG:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = SerialActiveMessageC$Receive$default$receive(arg_0x40935108, msg, payload, len);
#line 67
      break;
#line 67
    }
...
#line 67
# 233 "/opt/tinyos-2.1.1/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline uint8_t SerialActiveMessageC$Packet$payloadLength(message_t *msg)
#line 233
{
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t TestSerialC$AMControl$start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
#line 92
  TestSerialC$AMControl$startDone(error);
#line 92
}
#line 92
# 74 "/opt/tinyos-2.1.1/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
...
#line 117
  TestSerialC$AMControl$stopDone(error);
#line 117
}
#line 117
...
#line 71
{
  ...
  if (&TestSerialC$pkt[sim_node()] == msg) 
    {

      TestSerialC$busy[sim_node()] = FALSE;
    }
  else 
    {
      sim_log_debug(47U, "TestSerialC", "error on message pointer\n");
    }
}

# 256 "/opt/tinyos-2.1.1/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline void SerialActiveMessageC$AMSend$default$sendDone(uint8_t id, message_t *msg, error_t err)
#line 256
{
  return;
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void SerialActiveMessageC$AMSend$sendDone(am_id_t arg_0x409376f0, message_t * msg, error_t error){
#line 99
  switch (arg_0x409376f0) {
#line 99
    case AM_TESTSERIALMSG:
#line 99
...
#line 99
    default:
#line 99
      SerialActiveMessageC$AMSend$default$sendDone(arg_0x409376f0, msg, error);
#line 99
      break;
#line 99
    }
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40ad03a8){
#line 72
  switch (arg_0x40ad03a8) {
#line 72
    case 0U:
#line 72
      TestSerialC$Timer0$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40ad03a8);
#line 72
      break;
#line 72
    }
...
#line 46
  {
    sim_log_debug(51U, "Init", "LEDS: initialized.\n");
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "TestSerialC$busy"))
  {
    *addr = (uintptr_t)&TestSerialC$busy[__nesc_mote];
    *size = sizeof(TestSerialC$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TestSerialC$pkt"))
  {
    *addr = (uintptr_t)&TestSerialC$pkt[__nesc_mote];
    *size = sizeof(TestSerialC$pkt[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  TestSerialC$busy[__nesc_mote] = FALSE;
  memset((void *)&TestSerialC$pkt[__nesc_mote], 0, sizeof TestSerialC$pkt[__nesc_mote]);
